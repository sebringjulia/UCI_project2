function drawScatter(data,year,country){
	...
	var chosenXAxis = 'Economy (GDP per Capita)',
		chosenYAxis = 'Freedom';
	...
	var economyLabel = xLabelsGroup.append('text')
		.attr('x', 0)
		.attr('y', 20)
		.attr('value', 'Economy (GDP per Capita)')
	...
	var healthLabel = xLabelsGroup.append('text')
		.attr('x', 0)
		.attr('y', 60)
		.attr('value', 'Health (Life Expectancy)')
		.classed('aText inactive', true)
	...
	var trustLabel = yLabelsGroup.append('text')
		...
		.attr('value', 'Trust (Government Corruption)')
		.classed('aText inactive', true)
	...
	xLabelsGroup.selectAll('text')
		.on('click', function() {
			...
			if (value !== chosenXAxis) {
			    ...
			    if (chosenXAxis === 'Economy (GDP per Capita)') {
					economyLabel
				        .classed('active', true)
			    ...
			    else if (chosenXAxis === 'Health (Life Expectancy)'){
			        economyLabel
				        .classed('active', false)
				            .classed('inactive', true);
				    familyLabel
	...
	yLabelsGroup.selectAll('text')
		.on('click', function() {
			...
			if (value !== chosenYAxis) {
			    ...
			    else if (chosenYAxis === 'Trust (Government Corruption)'){
			        freedomLabel
				        .classed('active', false)
				        .classed('inactive', true);
				    trustLabel
